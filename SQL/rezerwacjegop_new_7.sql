...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Sty 2019, 12:19
...
--
-- Struktura tabeli dla tabeli `pro_i_uzyt`
--

CREATE TABLE `pro_i_uzyt` (
  `id_projekt` int(11) NOT NULL,
...
--
-- Indeksy dla tabeli `pro_i_uzyt`
--
ALTER TABLE `pro_i_uzyt`
...
--
-- Ograniczenia dla tabeli `pro_i_uzyt`
--
ALTER TABLE `pro_i_uzyt`
