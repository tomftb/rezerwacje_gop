...
--
-- Host: 127.0.0.1
-- Czas generowania: 08 Sty 2019, 07:55
...
(4, 4, 'projekt techniczny', 3, 'addDoc0', '0'),
(5, 4, 'metodyka', 4, 'addDoc1', '0'),
(6, 4, 'umowa', 5, 'addDoc2', '0'),
(7, 4, 'asd123', 4, 'pdfExtra0', '0'),
(8, 5, 'projekt techniczny', 3, 'addDoc0', '0'),
(9, 5, 'metodyka', 4, 'addDoc1', '0'),
(10, 5, 'umowa', 5, 'addDoc2', '0'),
(11, 5, 'asd123', 4, 'pdfExtra0', '0');
...
(4, '', '2019-01-04 12:10:44', 'umowy', 'umowa', 'sdf234', 'asdas123413', 'Ogonowski Waldemar', 26, '0000-00-00', '0000-00-00', '0000-00-00', 'Pielesz Aleksander', 30, '', 0, '', 0, 'n', 0, '', 1, '0000-00-00 00:00:00', '2019-01-04 11:10:44'),
(5, 'tborczynski', '2019-01-04 12:12:58', 'umowy', 'umowa', 'sadf123', 'asda123', 'Biesaga Jacek', 4, '0000-00-00', '0000-00-00', '0000-00-00', 'Bąk Mateusz', 2, '', 0, '', 0, 'n', 0, 'tborczynski', 1, '0000-00-00 00:00:00', '2019-01-04 11:12:58');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `projekt_pracownik`
--
...
CREATE TABLE `projekt_pracownik` (
  ...
  `mod_user_id` int(11) NOT NULL,
  `mod_user_name` varchar(100) COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `uzytkownik` (
  ...
  `dat_usn` datetime NOT NULL,
  `tmp_imie` varchar(30) NOT NULL,
  `tmp_nazwisko` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Tomasz', 'Borczyński', 'Programista', 'tborczynski', '', 'tomasz.borczynski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', ''),
(2, 'Mateusz', 'Bąk', 'GDS QC_InField', 'mbak', '', 'mateusz.bąk@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Mateusz', 'Bąk'),
(3, 'Szymon', 'Białek', 'GDS QC_InField', 'sbialek', '', 'szymon.białek@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Szymon', 'Białek'),
(4, 'Jacek', 'Biesaga', 'Kierownik Zespołu Projektów 2', 'jbiesaga', '', 'jacek.biesaga@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Jacek', 'Biesaga'),
(5, 'Elżbieta', 'Bobakowska', 'GDS QC_InField', 'ebobakowska', '', 'elżbieta.bobakowska@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Elżbieta', 'Bobakowska'),
(6, 'Joanna', 'Burliga-Drąg', 'Specjalista Geofizyk', 'jburliga-drag', '', 'joanna.burliga-drąg@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Joanna', 'Burliga-Drąg'),
(7, 'Tomasz', 'Buszka', 'Specjalista Geofizyk', 'tbuszka', '', 'tomasz.buszka@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Tomasz', 'Buszka'),
(8, 'Justyna', 'Dalętka', 'Samodzielny Inż. Geofizyk', 'jdaletka', '', 'justyna.dalętka@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Justyna', 'Dalętka'),
(9, 'Robert', 'Dybalak', 'Senior Geofizyk', 'rdybalak', '', 'robert.dybalak@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Robert', 'Dybalak'),
(10, 'Rafał', 'Gadubała', 'Specjalista Geofizyk', 'rgadubala', '', 'rafał.gadubała@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Rafał', 'Gadubała'),
(11, 'Dorota', 'Gawrońska', 'Samodzielny Inż. Geofizyk', 'dgawronska', '', 'dorota.gawrońska@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Dorota', 'Gawrońska'),
(12, 'Dariusz', 'Gawroński', 'Specjalista Geofizyk', 'dgawronski', '', 'dariusz.gawroński@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Dariusz', 'Gawroński'),
(13, 'Ryszard', 'Hodiak', 'GDS QC_InField', 'rhodiak', '', 'ryszard.hodiak@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Ryszard', 'Hodiak'),
(14, 'Paulina', 'Hyjek', 'Starszy Inż. Geofizyk', 'phyjek', '', 'paulina.hyjek@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Paulina', 'Hyjek'),
(15, 'Piotr', 'Idzikowski', 'Kierownik Pracowni Baz Danych Sejsmicznych', 'pidzikowski', '', 'piotr.idzikowski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Piotr', 'Idzikowski'),
(16, 'Wojciech', 'Kobusiński', 'Kierownik Zespołu Przetwarzania Specjalistycznego', 'wkobusinski', '', 'wojciech.kobusiński@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Wojciech', 'Kobusiński'),
(17, 'Krzysztof', 'Kolasiński', 'Kierownik Ośrodka Obliczeniowego', 'kkolasinski', '', 'krzysztof.kolasiński@geofizyka', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Krzysztof', 'Kolasiński'),
(18, 'Joanna', 'Komorowska', 'Specjalista Geofizyk', 'jkomorowska', '', 'joanna.komorowska@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Joanna', 'Komorowska'),
(19, 'Henryk', 'Kowalski', 'Kierownik Pracowni Wdrożeń i Rozwoju', 'hkowalski', '', 'henryk.kowalski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Henryk', 'Kowalski'),
(20, 'Sławomir', 'Lubomski', 'Specjalista Geofizyk', 'slubomski', '', 'sławomir.lubomski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Sławomir', 'Lubomski'),
(21, 'Krzysztof', 'Łaszewski', 'Specjalista Geofizyk', 'klaszewski', '', 'krzysztof.łaszewski@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Krzysztof', 'Łaszewski'),
(22, 'Dorota', 'Masiukiewicz', 'Specjalista Geofizyk', 'dmasiukiewicz', '', 'dorota.masiukiewicz@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Dorota', 'Masiukiewicz'),
(23, 'Wojciech', 'Mucha', 'Starszy Inż. Geofizyk', 'wmucha', '', 'wojciech.mucha@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Wojciech', 'Mucha'),
(24, 'Małgorzata', 'Nowak', 'Specjalista Geofizyk', 'mnowak', '', 'małgorzata.nowak@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Małgorzata', 'Nowak'),
(25, 'Dorota', 'Nussbeutel', 'Specjalista Geofizyk', 'dnussbeutel', '', 'dorota.nussbeutel@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Dorota', 'Nussbeutel'),
(26, 'Waldemar', 'Ogonowski', 'Kierownik Zespołu Projektów 2', 'wogonowski', '', 'waldemar.ogonowski@geofizyka.p', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Waldemar', 'Ogonowski'),
(27, 'Grzegorz', 'Orlik', 'Samodzielny Inż. Geofizyk', 'gorlik', '', 'grzegorz.orlik@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Grzegorz', 'Orlik'),
(28, 'Maciej', 'Orzeszko', 'Senior Geofizyk', 'morzeszko', '', 'maciej.orzeszko@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Maciej', 'Orzeszko'),
(29, 'Marcin', 'Osiński', 'Specjalista Geofizyk', 'mosinski', '', 'marcin.osiński@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Marcin', 'Osiński'),
(30, 'Aleksander', 'Pielesz', 'Specjalista Geofizyk', 'apielesz', '', 'aleksander.pielesz@geofizyka.p', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Aleksander', 'Pielesz'),
(31, 'Marek', 'Popielarski', 'Senior Geofizyk', 'mpopielarski', '', 'marek.popielarski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Marek', 'Popielarski'),
(32, 'Marek', 'Rabiasz', 'Senior Geofizyk', 'mrabiasz', '', 'marek.rabiasz@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Marek', 'Rabiasz'),
(33, 'Dariusz', 'Saj', 'Specjalista Geofizyk', 'dsaj', '', 'dariusz.saj@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Dariusz', 'Saj'),
(34, 'Katarzyna', 'Siemińska', 'Samodzielny Inż. Geofizyk', 'ksieminska', '', 'katarzyna.siemińska@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Katarzyna', 'Siemińska'),
(35, 'Radosław', 'Sinicki', 'GDS QC_InField', 'rsinicki', '', 'radosław.sinicki@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Radosław', 'Sinicki'),
(36, 'Romuald', 'Sobociński', 'Senior Geofizyk', 'rsobocinski', '', 'romuald.sobociński@geofizyka.p', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Romuald', 'Sobociński'),
(37, 'Waldemar', 'Susmarski', 'Senior Geofizyk', 'wsusmarski', '', 'waldemar.susmarski@geofizyka.p', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Waldemar', 'Susmarski'),
(38, 'Magdalena', 'Szal', 'Starszy Inż. Geofizyk', 'mszal', '', 'magdalena.szal@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Magdalena', 'Szal'),
(39, 'Magdalena', 'Szczechowska-Milczarek', 'Specjalista Geofizyk', 'mszczechowska', '', 'magdalena.szczechowska-milczar', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Magdalena', 'Szczechowska-Milczarek'),
(40, 'Marcin', 'Szybiński', 'Samodzielny Inż. Geofizyk', 'mszybinski', '', 'marcin.szybiński@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Marcin', 'Szybiński'),
(41, 'Tomasz', 'Szydło', 'Specjalista Geofizyk', 'tszydlo', '', 'tomasz.szydło@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Tomasz', 'Szydło'),
(42, 'Karol', 'Świętochowski', 'Starszy Inż. Geofizyk', 'kswietochowski', '', 'karol.świętochowski@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Karol', 'Świętochowski'),
(43, 'Robert', 'Theis', 'Specjalista Geofizyk', 'rtheis', '', 'robert.theis@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Robert', 'Theis'),
(44, 'Justyna', 'Tlałka', 'Specjalista Geofizyk', 'jtlalka', '', 'justyna.tlałka@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Justyna', 'Tlałka'),
(45, 'Seweryn', 'Tlałka', 'Główny Technolog GOP', 'stlalka', '', 'seweryn.tlałka@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Seweryn', 'Tlałka'),
(46, 'Tomasz', 'Torba', 'GDS QC_InField', 'ttorba', '', 'tomasz.torba@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Tomasz', 'Torba'),
(47, 'Tomasz', 'Ulman', 'Senior Geofizyk', 'tulman', '', 'tomasz.ulman@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Tomasz', 'Ulman'),
(48, 'Elżbieta', 'Ulman', 'Samodzielny Inż. Geofizyk', 'eulman', '', 'elżbieta.ulman@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Elżbieta', 'Ulman'),
(49, 'Katarzyna', 'Van Marke De Lumen', 'Samodzielny Referent ds.. Ekonomicznych', 'kmarke', '', 'katarzyna.van marke de lumen@g', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Katarzyna', 'Van Marke De Lumen'),
(50, 'Piotr', 'Wędrowski', 'Senior Geofizyk', 'pwedrowski', '', 'piotr.wędrowski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Piotr', 'Wędrowski'),
(51, 'Marcin', 'Wilk', 'Specjalista Geofizyk', 'mwilk', '', 'marcin.wilk@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Marcin', 'Wilk'),
(52, 'Jadwiga', 'Wołk', 'Specjalista Geofizyk', 'jwolk', '', 'jadwiga.wołk@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Jadwiga', 'Wołk'),
(53, 'Małgorzata', 'Zalewska', 'Samodzielny Inż. Geofizyk', 'mzalewska', '', 'małgorzata.zalewska@geofizyka.', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Małgorzata', 'Zalewska'),
(54, 'Rafał', 'Zalewski', 'Samodzielny Inż. Geofizyk', 'rzalewski', '', 'rafał.zalewski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Rafał', 'Zalewski'),
(55, 'Grzegorz', 'Ząbik', 'Senior Geofizyk', 'gzabik', '', 'grzegorz.ząbik@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Grzegorz', 'Ząbik'),
(56, 'Anna', 'Zduniak', 'Samodzielny Inż. Geofizyk', 'azduniak', '', 'anna.zduniak@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Anna', 'Zduniak'),
(57, 'Karol', 'Żurawski', 'Samodzielny Inż. Geofizyk', 'kżurawski', '', 'karol.żurawski@geofizyka.pl', 'a', 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'Karol', 'Żurawski');
...
--
-- Zastąpiona struktura widoku `v_udzial_procent_uzyt`
-- (Zobacz poniżej rzeczywisty widok)
--
CREATE TABLE `v_udzial_procent_uzyt` (
);

-- --------------------------------------------------------

--
-- Zastąpiona struktura widoku `v_udzial_uzyt_proj`
-- (Zobacz poniżej rzeczywisty widok)
--
CREATE TABLE `v_udzial_uzyt_proj` (
);
...
--
-- Struktura widoku `v_udzial_procent_uzyt`
--
DROP TABLE IF EXISTS `v_udzial_procent_uzyt`;

CREATE ALGORITHM=UNDEFINED DEFINER=`rezerwacjegop`@`localhost` SQL SECURITY DEFINER VIEW `v_udzial_procent_uzyt`  AS  select `projekt_uzytkownik`.`id_uzytkownik` AS `idUzytkownik`,count(`pro_i_uzyt`.`udzial_procent`) AS `procentowyUdział` from `pro_i_uzyt` where (`pro_i_uzyt`.`wsk_u` = '0') group by `pro_i_uzyt`.`id_uzytkownik` ;

-- --------------------------------------------------------

--
-- Struktura widoku `v_udzial_uzyt_proj`
--
DROP TABLE IF EXISTS `v_udzial_uzyt_proj`;

CREATE ALGORITHM=UNDEFINED DEFINER=`rezerwacjegop`@`localhost` SQL SECURITY DEFINER VIEW `v_udzial_uzyt_proj`  AS  select `projekt_uzytkownik`.`id_uzytkownik` AS `idUzytkownik`,`projekt_uzytkownik`.`id_projekt` AS `idProjekt` from `projekt_uzytkownik` where (`projekt_uzytkownik`.`wsk_u` = '0') order by `projekt_uzytkownik`.`id_uzytkownik` ;
...
--
-- Indeksy dla tabeli `projekt_pracownik`
--
ALTER TABLE `projekt_pracownik`
  ADD UNIQUE KEY `uc_id_proj_id_uzyt_2` (`id_uzytkownik`,`id_projekt`),
  ADD KEY `fk_id_projekt_2` (`id_projekt`),
  ADD KEY `fk_mod_user_id_2` (`mod_user_id`);
...
ALTER TABLE `projekt_dok`
  ...
  ADD CONSTRAINT `FK_id_projekt` FOREIGN KEY (`id_projekt`) REFERENCES `projekt_nowy` (`id`);
...
--
-- Ograniczenia dla tabeli `projekt_pracownik`
--
ALTER TABLE `projekt_pracownik`
  ADD CONSTRAINT `fk_id_projekt_2` FOREIGN KEY (`id_projekt`) REFERENCES `projekt_nowy` (`id`),
  ADD CONSTRAINT `fk_id_user_2` FOREIGN KEY (`id_uzytkownik`) REFERENCES `uzytkownik` (`id`),
  ADD CONSTRAINT `fk_mod_user_id_2` FOREIGN KEY (`mod_user_id`) REFERENCES `uzytkownik` (`id`);
