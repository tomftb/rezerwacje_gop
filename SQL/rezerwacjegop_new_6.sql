...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Sty 2019, 12:03
...
--
-- Struktura tabeli dla tabeli `projekt_zespol`
--

CREATE TABLE `projekt_zespol` (
  `id` int(11) NOT NULL,
  `id_projekt` int(11) NOT NULL,
  `uzytkownik` varchar(60) COLLATE utf8_polish_ci NOT NULL,
...
--
-- Indeksy dla tabeli `projekt_zespol`
--
ALTER TABLE `projekt_zespol`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_id_uzytkownik` (`id_uzytkownik`),
  ADD KEY `FK_id_zesp_projekt` (`id_projekt`);
...
--
-- AUTO_INCREMENT dla tabeli `projekt_zespol`
--
ALTER TABLE `projekt_zespol`
...
--
-- Ograniczenia dla tabeli `projekt_zespol`
--
ALTER TABLE `projekt_zespol`
  ADD CONSTRAINT `FK_id_uzytkownik` FOREIGN KEY (`id_uzytkownik`) REFERENCES `uzytkownik` (`id`),
  ADD CONSTRAINT `FK_id_zesp_projekt` FOREIGN KEY (`id_projekt`) REFERENCES `projekt_nowy` (`id`);
