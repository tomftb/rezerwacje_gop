    ...
    <div class="row">
        <div class=" col-sm-4" >
            <div class="btn pull-left mt-0" > 
                 <button id='pCreate' class="btn btn-info pull-right mr-0 mb-0 mt-0 ml-1" data-toggle="modal" data-target="#AdaptedModal" onclick="newProject()">Dodaj projekt</button>
            </div> 
        </div>
        <div class=" col-sm-4">
        ...
        <div class=" col-sm-4">
            <div class="row float-right mr-4">
                ...
                <div class="sm-col-4">
                    <input class="ml-1 form-control mt-1" onchange="ajax.getData('getprojectslike&filter='+this.value)"/>
                </div>
            </div>
        </div>
    </div>
